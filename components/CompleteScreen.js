...
import { StyleSheet, View, Animated, PanResponder, Dimensions, Text, ImageBackground, Easing } from 'react-native';
...
const CompleteScreen = ({ navigation }) => {
  ...
  return (
    <ImageBackground
      source={require('../assets/finalcompletescreen.jpeg')} // Replace with your image path
